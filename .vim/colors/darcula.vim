...
" Josh Glendenning | Edited by Casey Avila
...
call s:highlight("CursorLine",    s:NONE,            s:NONE,          "NONE")
call s:highlight("CursorLineNr",  s:LIGHTER_GREY,    s:NONE,          "NONE")
call s:highlight("ColorColumn",   s:NONE,            s:DARKER_GREY,          "NONE")
call s:highlight("CursorColumn",  s:NONE,            s:GREY,          "NONE")

" Windows and tabs
call s:highlight("LineNr",        s:GREY,            s:NONE,          "NONE")
...
" Popup menu
call s:highlight("Pmenu",         s:WHITE,           s:DARK_GREY,     "NONE")
call s:highlight("PmenuSel",      s:DARKER_GREY,     s:ORANGE,        "NONE")
call s:highlight("PmenuSbar",     s:WHITE,           s:DARKER_GREY,   "NONE")
